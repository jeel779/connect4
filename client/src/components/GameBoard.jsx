      ...
      <div className="mb-6 relative z-10">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex gap-2">
            {gameState.gameOver && inviteState.pendingInvite === 'sent' && (
            ...
            {gameState.gameOver && inviteState.pendingInvite === 'received' && (
              <div className="flex gap-2">
                <button
            ...
            {gameState.gameOver && !inviteState.pendingInvite && (
              <button
                    ...
                    return (
                      <div
                        ...
                        className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full border-2 transition-all duration-200 ${
                          ...
                          gameState.gameOver && isWinningCell(row, col)
                            ? 'ring-4 ring-green-500 dark:ring-green-400 ring-opacity-75 animate-pulse'
                            : ''
                        }`}
                        style={{
